app.controller('cannelle_appCtrl', ['$scope', '$sce', '$timeout', '$window', '$filter', '$http', function ($scope, $sce, $timeout, $window, $filter, $http) {
    ...
    $scope.resize = function () {
        ...
        $('.minheight').css('min-height', (windowHeight - bandeauHeight) + 'px');
        $('.maxheight').css('max-height', (windowHeight - bandeauHeight) - 50 + 'px');
        $('.height').css('height', (windowHeight - bandeauHeight) + 'px');
    };
    ...
    $scope.escapeImgPath = function (img) {
        return "\"" + img + "\"";
    };
